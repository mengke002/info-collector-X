...
def main():
    ...
    # 分析任务
        ...
        result = run_intelligence_report_task(hours=args.hours, limit=args.report_limit, flow=args.flow, candidate_multiplier=args.candidate_multiplier)
