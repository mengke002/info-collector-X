...
{{
  ...
  "deep_interpretation": "（**此项为重点**）结合以上分析，生成一个“文本深度洞察摘要”，该摘要将作为后续宏观分析的输入。摘要需自然融合3个层面（若能识别到）的信息：1.**核心信息**: 推文讨论的主要观点和关键信息是什么？2.**情绪意图**: 作者展现了怎样的情绪与语气？他/她发文的潜在动机是什么？3.**思想价值**: 这条推文试图引发读者怎样的思考或共鸣？注意要融合成一段自然连贯的话，不要分列点，350字左右"
}}
"""
